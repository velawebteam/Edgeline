      ...
      <div className="px-6 md:px-12 w-full max-w-[1800px] mx-auto">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-24 items-start md:pt-12">
          ...
          <div className="flex flex-col">
            <h2 className="text-5xl md:text-7xl editorial-title mb-8 leading-[0.9] uppercase tracking-tighter">
              {project.title}
            </h2>
          ...
          <div className="flex flex-col items-center">
            ...
            {/* Navigation Arrows */}
            <div className="flex justify-between items-center mt-6 w-full max-w-[70vh] md:max-w-none">
              <button 
                onClick={prevImage}
